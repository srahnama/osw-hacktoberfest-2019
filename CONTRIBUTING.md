...
- It's built with [Vue.js](https://github.com/vuejs/vue) framework and [BootstrapVue](https://github.com/bootstrap-vue/bootstrap-vue).
...
* **Perform a [cursory search](https://github.com/OSWeekends/osw-hacktoberfest-2019/issues)** to see if the problem has already been reported. If it has **and the issue is still open**, add a comment to the existing issue instead of opening a new one.
